...
async def dashboard_overview(
    ...
    meta_summary, meta_error = await fetch_meta_account_summary(db, ds, de, company_id=company_id)
    meta_campaigns = await fetch_meta_campaigns_for_dashboard(db, ds, de, company_id=company_id)
